...
// // Notification Component for Error Message
// const NotificationBar = ({ message, onClose }) => (
//   <div
//     className="fixed left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-red-600 text-white p-2 "
//     role="alert"
//   >
//     <span>{message}</span>
...
//         <NotificationBar message={error} onClose={() => setShowErrorNotification(false)} />
//       )}
...
//             <div className="w-6 h-6 border-4 border-t-4 border-blue-600 border-dashed rounded-full animate-spin"></div>
//           </div>
//         )}
