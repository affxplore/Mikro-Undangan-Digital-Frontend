export default function SeminarForm({ formData, handleChange }) {
  return (
<<<<<<< HEAD
    <div>
      <label className="block text-sm font-medium text-blue-700">Nama Penyelenggara Seminar</label>
...
=======
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-semibold text-gray-700 mb-1">Nama Penyelenggara Seminar</label>
        <input 
          type="text" 
